<li class="nav-item">
  <form action="">
    <div class="form-group">
      <label for="fKeywordNamaProduk" class="text-secondary font-weight-normal">Nama Produk</label>
    ...
    <div class="form-group">
      <label for="fKeywordNamaSupplier" class="text-secondary font-weight-normal">Nama Supplier</label>
